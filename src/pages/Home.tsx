          ...
          <div className="relative mx-auto grid max-w-6xl gap-12 px-5 py-16 lg:grid-cols-[1fr_0.82fr] lg:items-center lg:px-8 lg:py-24">
            ...
            <div className="relative lg:pl-12">
              <div className="hero-card hero-art">
                ...
                <div className="my-10 flex items-center gap-5"><div className="heart-price"><Heart size={58} strokeWidth={1.5} fill="currentColor" /><DollarSign size={27} strokeWidth={2.5} /></div><div><p className="text-3xl font-bold tracking-[-0.07em]">site pronto</p><p className="mt-2 text-sm leading-6 text-[#20231f]/55">domínio + hospedagem<br />para sua presença online</p></div></div>
        ...
        <section id="briefing" className="border-t border-[#20231f]/10 bg-[#ebe5d8]">
          <div className="mx-auto grid max-w-6xl gap-12 px-5 py-20 lg:grid-cols-[0.75fr_1.25fr] lg:px-8 lg:py-28">
            ...
            <form className="form-paper" onSubmit={submitBriefing}>
              ...
              {submitted && <div className="success-box mt-5"><Check size={18} /><span>Recebido. Agora você pode revisar a simulação abaixo, como vendedor da Legiva.</span></div>}
            </form>
          </div>
        </section>
