          ...
          <div className="relative mx-auto grid max-w-6xl gap-12 px-5 py-16 lg:grid-cols-[1fr_0.82fr] lg:items-center lg:px-8 lg:py-24">
            ...
            <div className="relative lg:pl-12">
              <div className="hero-card hero-art">
                ...
                <div className="my-10 flex items-center gap-5"><div className="heart-price"><Heart size={58} strokeWidth={1.5} fill="currentColor" /></div><div><p className="text-3xl font-bold tracking-[-0.07em]">site pronto</p><p className="mt-2 text-sm leading-6 text-[#20231f]/55">domínio + hospedagem<br />para sua presença online</p></div></div>
