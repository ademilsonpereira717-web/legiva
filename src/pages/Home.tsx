...
export default function Home() {
  ...
  />
</div><div><p className="text-3xl font-bold tracking-[-0.07em]">site pronto</p><p className="mt-2 text-sm leading-6 text-[#20231f]/55">domínio + hospedagem<br />para sua presença online</p></div></div>
